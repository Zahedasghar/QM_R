...
All efforts will be made to learn through hands-on practice using real-world data and problems in a wide range of fields [economics, business analytics, psychology, sociology, education, and public health]{.yellow}. How to write [beautiful documents/reports and awesome presentations in R] using [Quarto]{.yellow} will also be introduced which will increase participants productivity manifold.
