...
Labs and assignments will be based on real-world data and problems in a wide range of fields [economics, business analytics, psychology, sociology, education, and public health]{.yellow}. How to write [beautiful documents/reports and awesome presentations in R] using [Quarto]{.yellow} will also be introduced which will increase participants productivity manifold.
...
-   Concepts : control vs treatment, sampling methodologies, sample size calculation, sample bias, analyzing case studies

## 
![](ch1.png)
Observational studies & non-causal inference,
principles of experimental design & causal inference, exploratory data
analysis, sampling methodology and sample size, visualizing data to get deep insight, 
learning to have beautiful presenations, automatic citations inserted and have pdf/html/docs reports,
basics of probability and regression modeling
...
| 2        | Data, Variables, Summary Statistics            | Learning and Practicing all the concepts with data                           | [tidyverse in action](https://zahidasghar.com/QM_R/tidyverse_in_action#/title-slide)                                                                                |
