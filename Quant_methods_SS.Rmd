...
# Basics of quantitative investigation,Research Design {background-color= "#447099"}
...
###   WHO, Gapminder, nycflights,bikes,cia_factboo...
...
### [Most politicians facing scandals win reelection]{.pink}



### [Shallow men believe in luck, believe in circumstances. Strong men believe in cause and effect.] {.pink}Ralph Waldo Emerson, The Conduct of Life]{.yellow}
...
## Learning R and Quarto


### R: not only a statistical language but all documentation under one R 



### Beautiful reports, slides, pptx, pdf  documents , CV, research paper, book writing and a lot more in R, Reproducibility 
