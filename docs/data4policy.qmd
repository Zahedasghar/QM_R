...
format:
  revealjs: 
    ...
    #   data-background-image: images/data1.jpg
...
#  {background-image=images/public_policy.jpg background-opacity="0.2"}

::: r-fit-text
[Data for Public Policy]{.flow} <br> [Unlocking Insights, Transforming Policy]{style="color:purple;"} 
:::
